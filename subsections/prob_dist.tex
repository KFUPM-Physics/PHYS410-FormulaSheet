...
\begin{center}
    \frame{\includegraphics[width=13.5cm]{./figures/pt1.pdf}}\\
    \textbf{Figure 1:} Fermi--Dirac Dist. when $E_f=7eV$. For fermions\\
\end{center}
\par
\begin{center}
    \frame{\includegraphics[width=13.5cm]{./figures/pt2.pdf}}\\
    \textbf{Figure 2:} Bose--Einstein Dist. when $\mu=7eV$. For bosons\\
\end{center}
\begin{center}
    \frame{\includegraphics[width=13.5cm]{./figures/pt3.pdf}}\\
